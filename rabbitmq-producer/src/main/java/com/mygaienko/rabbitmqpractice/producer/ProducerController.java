...
public class ProducerController {
    ...
    @PostMapping("/post5")
    public void postMessage5(@RequestBody ProducerRequest producerRequest) throws JsonProcessingException {
        bindings.output5().send(new GenericMessage<>(producerRequest));
    }
